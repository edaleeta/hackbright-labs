...
def is_mel(name, email):
    ...
    True
    >>> is_mel('Balloonicorn', 'balloons@hb.com')
    False
    >>> is_mel('Mel Melitpolski', 'mel@notubermelon.com')
    True
    >>> is_mel('SmelMel Melitpolski', 'mel@ubermelon.com')
    True
...
def most_and_least_common_type(treats):
    ...
    Test an expected sample list of dictionaries:
    ...
    Test a list containing a single dictionary:
    ...
    Test a list that has a tie for both most and least dessert types:
    ...
    Test a list that has a tie for most dessert types:
